...
export const en: Dictionary = {
  ...
  auth2: {
    ...
    forgotBody: "Enter your address, we'll send you a link to choose a new one.",
  ...
  onboarding: {
    ...
    stepInstall: "Install",
    installBody:
      "CalisIQ installs on your home screen like a real app: full screen, direct camera access, and an analysis one tap away.",
  ...
  level: {
    ...
    nextGoal: "Next goal",
    hallSubtitle:
      "Every figure has its levels. Tap one to see the whole path, from the first variation to the last.",
    yourFigures: "Your figures",
    theLevels: "The levels",
    evolution: "Your progress",
    allFigures: "All figures",
    levelsUnlocked: (n, total) => `${n}/${total} levels unlocked`,
    notStartedFigure: "Not started",
    toUnlock: "To unlock",
  },
  handle: {
    label: "Public handle",
  ...
  social: {
    ...
    handle: "@calisiq.app",
    followHint: "Updates, and figures put to the test",
  },
  beta: {
    badge: "Beta",
    notice:
    ...
    freeTitle: "Free during the beta",
    freeBody:
      "CalisIQ is under active development. Access is completely free while the beta lasts.",
  },
  resetPassword: {
    title: "Choose a new password",
    body: "One last step before you get your account back.",
    ...
    invalidLinkBody: "It may have already been used, or expired. Request a new one from the sign-in screen.",
    requestNew: "Back to sign in",
    failed: (m: string) => `Could not save: ${m}`,
  },
  profile: {
    title: "Profile",
