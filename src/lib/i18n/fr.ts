...
export const fr = {
  ...
  criteria: {
    ...
    tags: {
      ...
      rep_protraction: ["Protraction", "Charge bras"],
  ...
  result: {
    ...
    toNextTier: (n: number, tier: string) => `${n} pts avant ${tier}`,
    topTier: "Palier maximal atteint",
    reps: "Répétitions",
    hold: "Hold",
    summary: "Résumé",
  ...
  auth2: {
    ...
    forgotBody: "Indique ton adresse, on t'envoie un lien pour en choisir un nouveau.",
  ...
  resetPassword: {
    ...
    body: "Une dernière étape avant de retrouver ton compte.",
    ...
    invalidLink: "Ce lien de réinitialisation n'est plus valide.",
    invalidLinkBody: "Il a peut-être déjà servi, ou a expiré. Demande-en un nouveau depuis l'écran de connexion.",
    requestNew: "Retour à la connexion",
    failed: (m: string) => `Impossible d'enregistrer : ${m}`,
  },
  profile: {
    title: "Profil",
